...
def dashboard_user():
    if 'logged_in' in st.session_state and st.session_state.logged_in:
        ...
        page = st.sidebar.selectbox("Navigate", ["Dashboard", "Cart","History","Chat Admin"])
        ...
        elif page == "Chat Admin":  # Tambahkan ini untuk memuat halaman History
            from app.chatadmin import chatadmin 
            chatadmin()
    else:
